...
function MyCard({ start, end, duration, title, prefix, icon, badge, info, badgeBg }: TypeCard) {
  ...
  return (
    <div className='tw-relative tw-text-white tw-rounded-[8px] tw-mb-[24] tw-bg-[#7a6fbe] tw-text-[16px] hover:tw-transition-all hover:tw-duration-300 hover:tw-translate-y-[-6px] tw-font-hel tw-shadow-card'>
      <div className='tw-p-[20px] tw-bg-[url(@/assets/bg-1.png)] tw-bg-cover'>
