...
const Thumb = ({ image, text = '' }: TypeThumb) => {
    return (
        <div className="tw-box-border tw-relative tw-shadow-thumb inline-block tw-w-[100%] tw-h-[100%] tw-rounded-full tw-cursor-default tw-border-4 tw-border-red-600 tw-bg-white tw-group">
